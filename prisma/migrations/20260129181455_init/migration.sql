...
-- CreateIndex
CREATE INDEX "ProductSize_sku_idx" ON "ProductSize"("sku");
...
-- CreateIndex
CREATE INDEX "OlfactoryNote_productId_idx" ON "OlfactoryNote"("productId");

-- CreateIndex
CREATE INDEX "OlfactoryNote_category_idx" ON "OlfactoryNote"("category");
