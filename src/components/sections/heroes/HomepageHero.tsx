      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 md:px-8">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="animate-fade-in opacity-0" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
            <p className="font-inter text-xs md:text-sm uppercase tracking-[0.2em] text-white/60 mb-6">
          ...
          <div className="animate-fade-in opacity-0" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
            <h1 className="font-cinzel text-[60px] md:text-[96px] lg:text-[120px] leading-[0.9] tracking-tight text-gold-500 mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
              OZ EXTRAIT
            </h1>
            <div className="h-[1px] w-24 mx-auto bg-gradient-to-r from-transparent via-gold-500 to-transparent" />
          </div>

          {/* Tagline */}
          <div className="animate-fade-in opacity-0" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
            <p className="font-playfair text-2xl md:text-4xl lg:text-5xl text-white leading-[1.3] max-w-3xl mx-auto">
              Extrait de Parfum.
              <br />
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 animate-fade-in opacity-0" style={{ animationDelay: '1600ms', animationFillMode: 'forwards' }}>
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 animate-fade-in opacity-0" style={{ animationDelay: '2000ms', animationFillMode: 'forwards' }}>
