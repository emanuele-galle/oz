    ...
    <section className="relative py-24 md:py-32 bg-cream-50">
      ...
      <div className="container-luxury">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="font-playfair text-lg md:text-xl text-stone-600 leading-relaxed max-w-2xl mx-auto">
            {description}
          </p>
          ...
          {meta && (
            <div className="flex items-center justify-center gap-6 pt-4">
              {meta.readTime && (
                <div className="flex items-center gap-2 text-sm font-inter text-stone-500">
