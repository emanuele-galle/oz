    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-luxury py-32">
        <div className="max-w-3xl">
          <div className="mb-8">
            <span className="inline-block px-4 py-2 border border-gold-500/30 text-gold-600 text-sm uppercase tracking-wider font-inter mb-6">
              La Fondatrice
            </span>
            <h1 className="font-cinzel text-6xl md:text-7xl lg:text-8xl text-gold-600 mb-6 animate-slide-up">
              Zoe Cristofoli
            </h1>
            <div className="h-1 w-32 bg-gold-500 mb-8" />
          </div>
