        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div ref={textRef as any}>
              <p className="font-playfair text-xl text-stone-700/80 leading-relaxed">
                OZ Extrait nasce dalla passione di <span className="text-gold-600">Zoe Cristofoli</span> per la
                profumeria di nicchia e l'arte della creazione olfattiva.
              </p>

              <p className="font-inter text-stone-700/70 leading-relaxed mt-4">
                Ogni fragranza è un'opera d'arte artigianale, realizzata con ingredienti selezionati dalle
                migliori coltivazioni del mondo. Con una concentrazione di <strong className="text-gold-600">Extrait de Parfum al 40%</strong>,
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              <div className="text-center">
                <div ref={counter1Ref as any} className="text-4xl font-cinzel text-gold-600 mb-2">40</div>
                <div className="text-sm text-stone-700/60 font-inter uppercase tracking-wide">
                  % Concentrazione
                </div>
              </div>
              <div className="text-center border-x border-white/10">
                <div className="flex items-baseline justify-center gap-1">
                  <div ref={counter2Ref as any} className="text-4xl font-cinzel text-gold-600 mb-2">12</div>
                  <span className="text-2xl font-cinzel text-gold-600">+</span>
                </div>
                <div className="text-sm text-stone-700/60 font-inter uppercase tracking-wide">
                  Ore di Durata
                </div>
              ...
              <div className="text-center">
                <div className="flex items-baseline justify-center gap-1">
                  <div ref={counter3Ref as any} className="text-4xl font-cinzel text-gold-600 mb-2">100</div>
                  <span className="text-2xl font-cinzel text-gold-600">%</span>
                </div>
                <div className="text-sm text-stone-700/60 font-inter uppercase tracking-wide">
                  Artigianale
