...
/**
 * Aurora — OGL-based animated aurora shader
 * Gold color stops for luxury ambiance
 * Source: React Bits (adapted for OZ Extrait)
 */
...
export function AnimatedMesh() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 opacity-15" style={{ mixBlendMode: 'multiply' }}>
      <AuroraInner
        colorStops={['#D4AF37', '#E8D48B', '#FEFDFB']}
        amplitude={0.8}
        blend={0.6}
        speed={0.5}
      />
